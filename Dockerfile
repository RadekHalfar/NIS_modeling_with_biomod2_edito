...
RUN R -e "install.packages(c('remotes', 'terra', 'dplyr', 'maxnet', 'randomForest', 'doParallel', 'paws', 'ggplot2', 'biomod2', 'R.utils', 'dismo'), repos='https://cloud.r-project.org/')"
RUN R -e "\
required <- c('remotes', 'terra', 'dplyr', 'maxnet', 'randomForest', 'doParallel', 'paws', 'ggplot2', 'biomod2', 'R.utils', 'dismo'); \
